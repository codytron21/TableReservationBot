...
class DateResolverDialog extends InterruptHandler {
    constructor(id) {
    ...
    async initialStep(stepContext) {
        ...
        const promptMessageText = 'On what date would you like make your reservation?';
        const promptMessage = MessageFactory.text(promptMessageText, promptMessageText, InputHints.ExpectingInput);

        const repromptMessageText = "I'm sorry, for best results, please enter your booking date including the month, day and year.";
